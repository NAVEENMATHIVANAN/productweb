    ...
    <body>
        <div class="home">
            <div class="header">
                ...
                Copyright &copy;2023 Developed by Naveen Kumar</footer></div>
            </div>
        </div>
    </body>
</html>
...
<html lang="en">
    <head>
        ...
        .ph1{
            background-image: url(/static/images/lip.jpg);
        ...
        .ph2{
            background-image: url(/static/images/eyeliner.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .ph3{
            background-image: url(/static/images/comp.jfif);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .ph4{
            background-image: url(/static/images/foundation.jpg);
            background-position-x: center;
            border:1px solid black;
            height:200px;
            width:30%;
        ...
        .ph5{
            background-image: url(/static/images/brush.jpg);
            background-position-x: center;
            border:1px solid black;
            height:200px;
            width:30%;
        ...
        .ph6{
            background-image: url(/static/images/prime.jpg);
            background-position-x: center;
            border:1px solid black;
            height:200px;
            width:30%;
...
<html lang="en">
    <head>
        ...
        .ceoph{
            background-image: url(/static/images/act2.jfif);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
        ...
        .manph1{
            background-image: url(/static/images/act1.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .manph2{
            background-image: url(/static/images/act4.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph1{
            background-image: url(/static/images/act6.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph2{
            background-image: url(/static/images/act3.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph3{
            background-image: url(/static/images/act7.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <div class="ceoph"></div>
                    <div class="ceo"><p align="center"><b><h2>Jhonny depp</h2></b></div>
                    <br>
                    <div class="text">
                        <p><b><u>Head executives</u></b></p><br>
                    </div>
                    <div class="manph1"></div>
                    <div class="man1"><p align="center"><b><h2>Deepika</h2></b></p></div>
                    <div class="manph2"></div>
                    <div class="man2"><p><b><h2>Samantha</h2></b></p></div>
                    <br>
                    <div class="text"><p><b><u>Managers</u></b></p></div><br>
                    <div class="amph1"></div>
                    <div class="am1"><p align="center"><b><h2>Vin Diesel</h2></b></p></div>
                    <div class="amph2"></div>
                    <div class="am2"><p align="center"><b><h2>Scarlett</h2></b></p></div>
                    <div class="amph3"></div>
                    <div class="am3"><p align="center"><b><h2>kiara</h2></b></p></div><br>
        ...
        <div class="home">
            <div class="header">
                <header>
                    ...
                    <a href="home.html" title="Home" style="color: darkred; text-decoration: none;"><b>Home</b></a></div>
                    <div class="prod">
                        <a href="product.html" title="Products" style="color: darkred; text-decoration: none;"><b>Product</b></a>
                    </div>
                    <div class="people">
                        <a href="people.html" title="People" style="color:darkred; text-decoration: none;"><b>People</b></a>
                    </div>
